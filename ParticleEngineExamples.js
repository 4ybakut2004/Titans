...
Examples =
{
	...
	smoke :
	{
		...
		positionSpread   : new THREE.Vector3( 0.01, 0, 0.01 ),

		velocityStyle    : Type.CUBE,
		velocityBase     : new THREE.Vector3( 0, 0.15, 0 ),
		velocitySpread   : new THREE.Vector3( 0.08, 0.05, 0.08 ), 
		accelerationBase : new THREE.Vector3( 0,-0.01,0 ),
		
		particleTexture : THREE.ImageUtils.loadTexture( 'textures/smoke.png' ),
		...
		sizeTween    : new Tween( [0, 0.0002], [0.0006, 0.024] ),
